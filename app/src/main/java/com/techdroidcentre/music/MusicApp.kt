...
import com.techdroidcentre.music.navigation.TopLevelDestination.Home
...
fun MusicApp(
    ...
    val destinations = listOf(Home, Songs, Albums, Artists)
    val navBackStackEntry by navController.currentBackStackEntryAsState()
    val currentDestination = navBackStackEntry?.destination
    val bottomBarRoutes = listOf(homeNavigationRoute, songsNavigationRoute, albumsNavigationRoute, artistsNavigationRoute)
